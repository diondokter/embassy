...
impl<'d> Watchdog<'d> {
    ...
    fn enable(&self) {
        self.info.mod_().modify(|w| w.set_wden(nxp_pac::wwdt0::vals::Wden::RUN));
    ...
    fn set_flexible_mode(&self) {
        self.info
            .mod_()
            .modify(|w| w.set_wdprotect(nxp_pac::wwdt0::vals::Wdprotect::FLEXIBLE));
    }
    ...
    fn enable_interrupt(&self) {
        self.info
            .mod_()
            .modify(|w| w.set_wdreset(nxp_pac::wwdt0::vals::Wdreset::INTERRUPT));
    }
    ...
    fn enable_reset(&self) {
        self.info
            .mod_()
            .modify(|w| w.set_wdreset(nxp_pac::wwdt0::vals::Wdreset::RESET));
    }
